...
class GifConverter:
    ...
    def __init__(self, path_in=None, path_out=None, resize=(320, 240)):
        ...
        """
        self.path_in  = path_in  or './Deploy_OpenSource_Package/예제파일/project/images/*.png'
        self.path_out = path_out or './Deploy_OpenSource_Package/예제파일/project/image_out/output.gif'
        self.resize   = resize
...
if __name__ == "__main__":
	# 클래스 테스트
	c = GifConverter("./Deploy_OpenSource_Package/예제파일/project/images/*.png", \
                     './Deploy_OpenSource_Package/예제파일/project/image_out/result.gif', \
                     (320,240))
	# 변환
	c.convert_gif()